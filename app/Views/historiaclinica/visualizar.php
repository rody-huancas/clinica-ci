    ...
    <div class="br-pagebody">
        ...
        <div class="br-section-wrapper mx-auto mb-5 container__historia" id="sHistoria">
            ...
            <div class="historia">
                ...
                <div class="container__historia d-flex flex-column align-items-center">
            ...
            <div class="row d-print-none mt-2">
                <div class="col-12 text-right"><button class="btn btn-primary" onclick="printHistoria()" style="cursor: pointer;"><i class="fa fa-print"></i> Imprimir</button></div>
            </div>
        </div>
        <!-- br-section-wrapper -->
    </div>
